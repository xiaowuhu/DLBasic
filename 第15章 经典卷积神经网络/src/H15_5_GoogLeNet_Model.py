...
class GoogLeNet(nn.Module):
    def __init__(self, in_ch, num_classes, aux_output = True):
        ...
        self.part3 = nn.Sequential(
            # 528 x 14 x 14
            # 4e
            Inception(528, c1_out=256, c2_out=[160,320], c3_out=[32,128], c4_out=128),
            # 832 x 14 x 14
            nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True),
            # 832 x 7 x 7
            # 5a
            Inception(832, c1_out=256, c2_out=[160,320], c3_out=[32,128], c4_out=128),
            # 832 x 7 x 7
            # 5b
            Inception(832, c1_out=384, c2_out=[192,384], c3_out=[48,128], c4_out=128),
        )
