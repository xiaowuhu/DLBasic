...
def color():
    ...
    save_data(train_data_name, images_train, label_train)
    save_data(test_data_name, images_test, label_test)
...
if __name__ == '__main__':
    train_data_name = "train_color.npz"
    test_data_name = "test_color.npz"
    color()
