...
class NeuralNet_5_7(object):
    ...
    # 网络训练
    def train(self, epoch, lrt, checkpoint=100):
        ...
        for i in range(epoch):
            ...
            for batch_id in range(batch_per_epoch):
                ...
                print("轮 %d, 训练集: loss %.5f, accu %.4f, 验证集: loss %.5f, accu %.4f - %.5f" %(i, train_loss, train_accu, val_loss, val_accu, self.lr))
