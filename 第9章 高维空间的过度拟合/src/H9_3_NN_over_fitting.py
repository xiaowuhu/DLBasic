...
class NN(Module):
    def __init__(self, optimizer = "SGD"):
        ...
        self.linear1 = layer.Linear(1, num_hidden_1, optimizer=optimizer)
        self.tanh1 = activator.Tanh()

        self.linear2 = layer.Linear(num_hidden_1, num_hidden_2, optimizer=optimizer)
        self.tanh2 = activator.Tanh()

        self.linear3 = layer.Linear(num_hidden_2, num_hidden_3, optimizer=optimizer)
        self.tanh3 = activator.Tanh()

        self.linear4 = layer.Linear(num_hidden_3, 1, optimizer=optimizer)
        self.loss = loss.MSE()
...
if __name__=="__main__":
    ...
    # model.save("over_fitting_model")
    # training_history.save_history("training_history_9.txt")
