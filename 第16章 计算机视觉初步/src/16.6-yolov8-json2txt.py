...
if __name__ == "__main__":
    jsonfilePath = "MY_DATA/demo_images"  # 要转换的json文件所在目录
    resultDirPath = "MY_DATA/demo_txt"  # 要生成的txt文件夹
    labelme2yolov2Seg(jsonfilePath=jsonfilePath, resultDirPath=resultDirPath, classList=["whiteCar","redCat"])  # 更改为自己的类别名
