...
def build_model():
    ...
    model = Sequential(
        ...
        layer.Flatten((output_channel, conv_output_length), conv_output_length * output_channel),
        layer.Tanh(),
        layer.Linear(conv_output_length * output_channel, 4, init_method="normal", optimizer="Adam"),
    )
...
if __name__=="__main__":
    ...
    params = HyperParameters(max_epoch=50, batch_size=32, learning_rate=0.01)
