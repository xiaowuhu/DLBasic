...
def load_data(train_file_name, test_file_name):
    ...
    data_loader.add_channel_info()  # 增加一维通道信息 N-C-W
...
def build_model():
    model = Sequential(
        layer.Conv1d((1,5), (1,4), init_method="normal", optimizer="Adam"),
        layer.Flatten((1, 2), 2),
