...
def generate_data(feature, count, name):
    ...
    data5 = generate_sin_rev(x, count, 0, noise)
    data6 = generate_cos_rev(x, count, 1, noise)
    data7 = generate_sawtooth_rev(x, count, 2, noise)
    data8 = generate_square_rev(x, count, 3, noise)
...
if __name__=="__main__":
    ...
    feature = 5
    generate_data(feature, 200, "train13_4.txt")
    generate_data(feature, 50, "test13_4.txt")
