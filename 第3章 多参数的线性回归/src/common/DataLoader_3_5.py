...
class DataLoader_3_5(object):
    ...
    def split_data(self, ratio=0.8):
        ...
        self.val_x = self.train_x[self.num_train:, 0:2]
        self.val_y = self.train_y[self.num_train:, -1:]
        # 训练集
        self.train_x = self.train_x[:self.num_train, 0:2]
        self.train_y = self.train_y[:self.num_train, -1:]
